...
app.get('/mithuntechnologies', function(request, response) {
    ...
    response.write("<h2><center> Thanks to Bhaskar and Balaji for all their efforts. Welcome to  Mithun Technologies. Please Contact +91-9980923226,++91-9980923216 for more information or send an email to devopstrainingblr@gmail.com <center></h2>" );
    response.end();
